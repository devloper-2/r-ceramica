...
export default function Navbar() {
  ...
  // Lazy initializers read localStorage once on mount — avoids setState-in-effect
  ...
  // (initial value already seeded via lazy initializer above)
  ...
  const navbarClass = [
    "fixed top-0 left-0 w-full z-50 transition-all duration-500 font-sans font-light",
    scrolled ? "bg-[#1B1B1B]/80 backdrop-blur-xl border-b border-white/5" : "",
    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-between p-4 md:p-5">
          ...
          {/* Desktop Logo */}
          <div className="hidden lg:flex flex-1 items-center logonew">
          ...
          {/* Desktop Navigation */}
          <div className="hidden globalnav lg:flex flex-1 justify-center items-center gap-12 xl:gap-16 text-[11px] uppercase tracking-[0.3em] font-medium text-white/80">
            <ul>
              {NAV_LINKS.map((link) => {
          ...
          {/* Desktop Right Tools */}
          <div className="hidden lg:flex flex-1 justify-end items-center gap-10 wooiconstyle">
            {/* Search */}
            <button
              onClick={openSearch}
              className="group"
          ...
          >
            ...
            >
              <div className="max-h-[70vh] overflow-y-auto p-4 md:p-6 space-y-8">
                <div>
                  ...
                  <div className="space-y-1">
                    {[
                      {
                        name: "Pietra Grey Slabs",
                        type: "High Gloss Porcelain",
                        href: "#",
                      },
                      {
                        name: "Calacatta Gold",
                        type: "Marble Selection",
                        href: "#",
                      },
                    ].map((item) => (
                      <Link
              ...
              <div className="bg-white/[0.02] border-t border-white/5 p-3 text-center">
                <Link
                  href="#"
                  className="text-[8px] uppercase tracking-[0.3em] text-white/20 hover:text-white transition-colors"
                >
                  View All Results
                </Link>
              </div>
