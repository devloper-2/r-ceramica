        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 md:gap-24 mb-24">
          ...
          <div className="space-y-10">
            ...
            <p className="text-white/40 text-[13px] leading-relaxed font-light max-w-sm">
              R Ceramica is a brand that believes in continuous development and
              growth. We always try to innovate and bring something new to reform
          ...
          <address className="space-y-10 not-italic">
            ...
            <div className="space-y-6 text-[13px] text-white/40 leading-relaxed">
              <div className="flex items-start gap-4 border-b border-white/5 pb-6">
                ...
                <p>
                  Opp. Ceramic City, B/h. Meldi Ma Temple, Lalpar, 8-A National
                  Highway, Morbi-363642. Gujarat (INDIA)
                </p>
              </div>
              <a href="tel:+919427410127" className="flex items-center gap-4 hover:text-white transition-colors">
                <Phone size={18} className="text-white/20" aria-hidden="true" />
                <span>PH: +91 94274 10127</span>
              </a>
              <a href="https://wa.me/919427410127" className="flex items-center gap-4 hover:text-white transition-colors">
                <WhatsAppIcon />
                <span>+91 94274 10127</span>
              </a>
              <a href="mailto:info@rceramica.com" className="flex items-center gap-4 hover:text-white transition-colors">
