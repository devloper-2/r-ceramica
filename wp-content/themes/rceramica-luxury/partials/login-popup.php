...
<div class="bg-[#0d0d0d] rounded-3xl p-10 shadow-2xl border border-white/10 w-full max-w-[400px] mx-auto relative">
    ...
    $('#verifyOtp').on('click', function(){
        ...
        $.post('<?php echo admin_url("admin-ajax.php"); ?>', {
            ...
            if(response.success){
                ...
                if($('#checkout-login-modal').length){

                    $('#checkout-login-modal').fadeOut(200, function(){
                        location.reload();
                    });
