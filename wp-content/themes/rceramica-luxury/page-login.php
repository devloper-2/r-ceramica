...
<main id="site-content" role="main">
    ...
    <div class="fixed inset-0 z-0 md:hidden opacity-20">
        <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&q=80"
    ...
    <!-- Navigation (Overlay) -->
    <nav
        class="absolute top-0 left-0 w-full z-50 py-8 px-8 md:px-16 flex justify-between items-center pointer-events-none">
        <a href="<?php echo esc_url(home_url("/")); ?>"
            class="group flex flex-col items-center pointer-events-auto">
            <img src="https://rceramica.com/logo/logo.png" alt="R CERAMICA"
                class="h-10 md:h-14 w-auto object-contain transition-all group-hover:opacity-80">
        </a>
        <a href="<?php echo esc_url(home_url("/")); ?>"
            class="text-[9px] md:text-[10px] uppercase tracking-[0.4em] text-white/40 hover:text-white transition-all flex items-center gap-2 pointer-events-auto">
    ...
    <main
        class="flex-grow flex flex-col md:flex-row min-h-[calc(100vh-100px)] relative z-10 transition-all duration-1000">
        ...
        <div class="hidden md:block md:w-1/2 lg:w-3/5 h-full min-h-[600px] relative overflow-hidden">
            <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&q=80"
                alt="Architecture" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent"></div>
            <div class="absolute bottom-16 left-16 max-w-sm">
                <h2 class="text-4xl font-display font-light uppercase tracking-[0.2em] mb-4 text-white">Elevating
                    <br>Spaces</h2>
                <p class="text-[10px] uppercase tracking-[0.3em] text-white/40 leading-relaxed">Exquisite surfaces for
                    the modern architectural masterpiece.</p>
            </div>
        </div>

        <!-- Right Side: Login Interface -->
        <div
            class="w-full md:w-1/2 lg:w-2/5 h-full min-h-[600px] flex items-center justify-center bg-[#0a0a0a]/80 md:bg-[#0a0a0a] backdrop-blur-sm md:backdrop-blur-none md:border-l border-white/5 relative">
            <!-- Decorative Subtle Accent -->
            <div
                class="absolute top-1/2 left-0 w-32 h-px bg-gradient-to-r from-[#c5a059]/40 to-transparent transform -translate-x-1/2 hidden lg:block">
            </div>

            <div
                class="w-full max-w-[400px] px-10 flex flex-col justify-start md:justify-center pt-32 md:pt-0 pb-20 md:pb-0">
