...
<main id="site-content" role="main">
        ...
        <div class="relative flex justify-between items-center px-4 md:px-12 h-20 md:h-28">
            ...
            <div id="nav-right" class="flex-1 flex justify-end items-center relative z-20">
                <div class="flex items-center gap-6 md:gap-10">
                    ...
                    <button onclick="toggleLangDropdown(event)" class="hidden md:block text-[11px] font-medium uppercase tracking-[0.2em] opacity-80" id="lang-text">EN</button>
                    <button onclick="toggleLoginDropdown(event)" class="hidden md:block"><span class="material-symbols-outlined font-light text-2xl md:text-3xl">account_circle</span></button>
                </div>
            </div>
            ...
            <div id="nav-center" class="absolute inset-0 flex justify-center items-center pointer-events-none px-12">
                <div id="search-input-container" class="w-full max-w-xl opacity-0 pointer-events-none translate-y-4 transition-all duration-500 relative">
                    <div class="flex items-center w-full relative pointer-events-auto">
                        <input type="text" id="search-input" placeholder="SEARCH..." class="w-full bg-transparent border-b border-white/20 text-white text-xs font-display font-light placeholder:text-white/30 focus:outline-none py-1 px-1 text-center uppercase tracking-[0.3em] focus:border-white transition-all">
                        <button onclick="toggleSearch()" class="absolute right-0 top-1/2 -translate-y-1/2 text-white/40"><i data-lucide="x" class="w-4 h-4"></i></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 bg-[#0a0a0a] z-[100] flex flex-col p-8 overflow-y-auto transform -translate-x-full transition-transform duration-500">
        ...
        <div class="flex flex-col space-y-1 gap-2 mb-12">
            ...
            <div id="mobile-user-info" class="hidden py-4 border-b border-white/5 text-left">
