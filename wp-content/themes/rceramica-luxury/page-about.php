...
<main id="site-content" role="main">
    ...
    <header class="relative min-h-[80vh] md:min-h-[85vh] flex items-center justify-center pt-16 md:pt-24 pb-12 md:pb-20 overflow-hidden group/hero">
        ...
        <div class="relative z-10 max-w-[1440px] px-6 text-center">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-8xl font-display font-light text-white uppercase tracking-[-0.02em] leading-tight blur-in">
                The Heritage of <br>
    ...
    <main class="relative">
        <!-- Philosophy Section -->
        <section class="py-16 md:py-16 md:py-24 lg:py-40 bg-[#111]">
            <div class="max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-6 md:p-10 md:gap-16 lg:gap-20 items-center">
        ...
        <section class="py-16 md:py-24 bg-[#0d0d0d] border-y border-white/5">
            <div class="max-w-[1440px] mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                    <div class="p-6 md:p-12 bg-white/[0.02] border border-white/5 rounded-sm group hover:border-amber-500/30 hover:bg-amber-500/[0.03] transition-all">
                    ...
                    <div class="p-6 md:p-12 bg-white/[0.02] border border-white/5 rounded-sm group hover:border-blue-500/30 hover:bg-blue-500/[0.03] transition-all">
                    ...
                    <div class="p-6 md:p-12 bg-white/[0.02] border border-white/5 rounded-sm group hover:border-emerald-500/30 hover:bg-emerald-500/[0.03] transition-all">
                    ...
                    <div class="p-6 md:p-12 bg-white/[0.02] border border-white/5 rounded-sm group hover:border-purple-500/30 hover:bg-purple-500/[0.03] transition-all">
        ...
        <section class="py-16 md:py-16 md:py-24 lg:py-40">
            <div class="max-w-[1440px] mx-auto px-6">
                <div class="flex flex-col items-center text-center mb-10 md:mb-16 lg:mb-24">
                    <span class="text-[10px] uppercase tracking-[0.5em] text-white/30 mb-6">Industrial Innovation</span>
                    <h2 class="text-3xl md:text-5xl lg:text-7xl font-display font-light text-white uppercase tracking-tight">The Factory of the Future</h2>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                    ...
                    <div class="group relative aspect-square overflow-hidden bg-[#1a1a1a]">
                        ...
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-blue-900/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-black/90 to-transparent">
                    ...
                    <div class="group relative aspect-square overflow-hidden bg-[#1a1a1a] lg:scale-105 lg:z-10 border border-white/10 hover:border-amber-500/50 transition-all overflow-hidden">
                        ...
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-amber-900/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-black/90 to-transparent">
                    ...
                    <div class="group relative aspect-square overflow-hidden bg-[#1a1a1a]">
                        ...
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-emerald-900/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-black/90 to-transparent">
        ...
        <section class="py-16 md:py-16 md:py-24 lg:py-40 bg-[#0d0d0d] relative overflow-hidden">
             <!-- Background Texture -->
             <div class="absolute top-1/2 left-0 -translate-y-1/2 text-[50vw] md:text-[30vw] font-display font-black text-white/[0.015] whitespace-nowrap pointer-events-none uppercase tracking-tighter select-none">
                VISIONARY
            </div>
            
            <div class="max-w-[1440px] mx-auto px-6 relative z-10">
                <div class="max-w-4xl mx-auto flex flex-col items-center text-center">
                    <div class="w-24 h-24 rounded-full overflow-hidden mb-8 md:mb-12 border border-white/20 transition-all duration-700 hover:scale-110">
        ...
        <section class="py-16 md:py-24 lg:py-40">
             <div class="max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 lg:gap-24 items-center">
                <div class="lg:col-span-4 space-y-6 md:space-y-6 md:space-y-10">
