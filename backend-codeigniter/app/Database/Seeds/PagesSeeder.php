...
class PagesSeeder extends Seeder
{
    public function run()
    {
        ...
        // ── CATALOGUE hero + request section ────────────────────────────────
        $catalogue = [
            ['type' => 'catalogueHero', 'content' => [
        ...
        $this->insertSections($sections, $pageId['catalogue'], $catalogue);
