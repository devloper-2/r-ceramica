      ...
      <header className="relative pt-40 md:pt-56 pb-24 md:pb-32 bg-[#080808] overflow-hidden">
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 md:px-16 text-center cat-fade-up">
          ...
          <h1 className="text-4xl md:text-7xl font-display font-light uppercase tracking-[0.2em] text-white mb-6 leading-[1.05]">
            {hero.title}<br />
            <span className="catalogue-ghost">{hero.titleLine2}</span>
          </h1>
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 md:px-16 mt-20 cat-fade-up" style={{ animationDelay: "0.2s" }}>
          <div className="grid grid-cols-3 border border-white/5 divide-x divide-white/5">
            {heroStats.map(({ val, label }: { val: string; label: string }) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center gap-6">
                ...
                <span className="text-[9px] uppercase tracking-[0.5em] text-[#c5a059]/80">
                  {request.eyebrow}
                </span>
              </div>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-light uppercase tracking-wider leading-tight">
                {request.title}<br />
                <span className="catalogue-ghost">{request.titleGhost}</span><br />
                {request.titleLine3}
              </h2>
            ...
            <div className="space-y-0">
              {benefits.map(({ icon: Icon, title: bTitle, body }, i) => (
                <div key={i}
                  ...
                  <div>
                    <h4 className="text-[11px] uppercase tracking-[0.2em] text-white mb-1">{bTitle}</h4>
